...
//     function handlesAddTodos (newTodo) {
...
//     return (
//         <div>
//             <input value={todos} type="text" onChange={(e) => setNewTodo(e.target.value)} />
//             <button onClick={handlesAddTodos}></button>
//             <ul>
//                 <li>{todos.map(todo => todo)}</li>
//             </ul>
//         </div>
//     )
// }
